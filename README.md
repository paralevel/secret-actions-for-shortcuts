...
[Open View](https://www.icloud.com/shortcuts/3d900f08e71e46da92513ef276025e09) <sup>${\color{DeepSkyBlue} hidden} {\color{DeepSkyBlue} on} {\color{DeepSkyBlue} macOS} {\color{DeepSkyBlue} only}$</sup><p>Opens the given View in Safari<p><sup>__Parameters__<br>Bookmarks • History • Reading List • Start Page • Tab Overview • Default Tab Group • Private Tab Group • Sidebar • Shared with You</sup>
...
[Find Bookmarks](https://www.icloud.com/shortcuts/f1bac8b295be482bbca14f6be591ff84) <sup>${\color{DeepSkyBlue} hidden} {\color{DeepSkyBlue} on} {\color{DeepSkyBlue} macOS} {\color{DeepSkyBlue} only}$</sup><p>Finds Safari bookmarks<p><sup>__Options__<br>Add Filter • Sort by • Limit</sup><br>

<br>

[Open Bookmark](https://www.icloud.com/shortcuts/656c86427f9d435fb416bd287f207c4b) <sup>${\color{DeepSkyBlue} hidden} {\color{DeepSkyBlue} on} {\color{DeepSkyBlue} macOS} {\color{DeepSkyBlue} only}$</sup><p>Opens the given bookmark in a new tab in the current tab group
...
[Create New Tab](https://www.icloud.com/shortcuts/65a7ba0a4cb54084a46744c4948407b3) <sup>${\color{DeepSkyBlue} hidden} {\color{DeepSkyBlue} on} {\color{DeepSkyBlue} macOS} {\color{DeepSkyBlue} only}$</sup><p>Opens Safari and creates a new blank tab – in the current tab group on macOS – in the default tab group on iOS

<br>

[Find Tabs](https://www.icloud.com/shortcuts/ce0ec1db3e7a4d60928af67ad6e21f2c) <sup>${\color{DeepSkyBlue} hidden} {\color{DeepSkyBlue} on} {\color{DeepSkyBlue} macOS} {\color{DeepSkyBlue} only}$</sup><p>Finds Safari tabs – doesn't work in the Private Tab Group<p><sup>__Options__<br>Add Filter • Sort by • Limit</sup><br>
...
[Switch Tab](https://www.icloud.com/shortcuts/79960341e47a40c7a7246bc2a0f45280) <sup>${\color{DeepSkyBlue} hidden} {\color{DeepSkyBlue} on} {\color{DeepSkyBlue} macOS} {\color{DeepSkyBlue} only}$</sup><p>Opens Safari and switches to the given tab<p><sup>__Parameters__<br>Tab</sup>

<br>

[Close Tab](https://www.icloud.com/shortcuts/8b07de524c214f859a32366905b9cc32) <sup>${\color{DeepSkyBlue} hidden} {\color{DeepSkyBlue} on} {\color{DeepSkyBlue} macOS} {\color{DeepSkyBlue} only}$</sup><p>Opens Safari and closes the given tab<p><sup>__Parameters__<br>Tab</sup>

<br>

[Open Tab Group](https://www.icloud.com/shortcuts/a03c00999a574a8a9c0a78b92aa6282f) <sup>${\color{DeepSkyBlue} hidden} {\color{DeepSkyBlue} on} {\color{DeepSkyBlue} macOS} {\color{DeepSkyBlue} only}$</sup><p>Opens the given tab group in Safari<p><sup>__Parameters__<br>Tab Group</sup>

<br>

[Create Tab Group](https://www.icloud.com/shortcuts/45a42efecf8f4c03b6de081e6a7667b8) <sup>${\color{DeepSkyBlue} hidden} {\color{DeepSkyBlue} on} {\color{DeepSkyBlue} macOS} {\color{DeepSkyBlue} only}$</sup><p>Opens Safari and creates a new tab group with the given name (or “Untitled” if no name is given)<p><sup>__Options__<br>Tab Group Name</sup>

<br>

[Find Tab Groups](https://www.icloud.com/shortcuts/675a0799c41943fe85ecb51bb3984e7d) <sup>${\color{DeepSkyBlue} hidden} {\color{DeepSkyBlue} on} {\color{DeepSkyBlue} macOS} {\color{DeepSkyBlue} only}$</sup><p>Finds Safari tab groups<p><sup>__Options__<br>Add Filter • Sort by • Limit</sup><br>
